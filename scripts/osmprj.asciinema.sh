...
run "osmprj init --db postgresql://postgres@localhost:65432/postgres" 0.5 2

say "# Data sources are added with osmprj add <source>" 2
run "osmprj add monaco" 0.5 2

say "# The --theme option lets you choose various schema layouts" 2
run "osmprj add bremen --theme pgosm" 0.5 2
